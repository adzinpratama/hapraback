                        ...
                        <div class="todo-app-list">
                            ...
                            <div class="todo-task-list-wrapper list-group">
                                ...
                                <div class="widget-content" id="list-kategori">
                                    ...
                                    <ul class="list-group hirarki kategori" id="drag-container">
                                    ...
                                    <form id="form-modal-todo" class="todo-modal needs-validation" novalidate
                                        ...
                                        <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                                            <div class="action-tags">
                                                ...
                                                <div class="form-group position-relative">
                                                    <label for="task-assigned"
                                                        class="form-label d-block">Assignee</label>
                                                    <select class="select2 form-control" id="task-assigned"
                                                        name="task-assigned">
                                                        <option
                                                            data-img="{{ asset('app-assets/images/portrait/small/avatar-s-3.jpg') }}"
                                                            value="Phill Buffer" selected>
                                                            Phill Buffer
                                                        </option>
                                                        <option
                                                            data-img="{{ asset('app-assets/images/portrait/small/avatar-s-1.jpg') }}"
                                                            value="Chandler Bing">
                                                            Chandler Bing
                                                        </option>
                                                        <option
                                                            data-img="{{ asset('app-assets/images/portrait/small/avatar-s-4.jpg') }}"
                                                            value="Ross Geller">
                                                            Ross Geller
                                                        </option>
                                                        <option
                                                            data-img="{{ asset('app-assets/images/portrait/small/avatar-s-6.jpg') }}"
                                                            value="Monica Geller">
                                                            Monica Geller
                                                        </option>
                                                        <option
                                                            data-img="{{ asset('app-assets/images/portrait/small/avatar-s-2.jpg') }}"
                                                            value="Joey Tribbiani">
                                                            Joey Tribbiani
                                                        </option>
                                                        <option
                                                            data-img="{{ asset('app-assets/images/portrait/small/avatar-s-11.jpg') }}"
                                                            value="Rachel Green">
                                                            Rachel Green
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="form-group my-1">
                                                ...
                                                <button type="button"
                                                    class="btn btn-primary d-none update-btn update-todo-item mr-1">Update</button>
